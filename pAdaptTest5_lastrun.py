...
expName = 'pAdaptTest5'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\p-adapt-test5\\pAdaptTest5_lastrun.py',
...
for thisTrials3 in trials3:
    ...
    if (taskVer == '6' or taskVer == '12'):
        if (trials3.thisN <= 23):
            ang = 7.5
            rtd = ang*(pi/180)
        elif (trials3.thisN > 23 and trials2.thisN <= 47):
            ang = 15
            rtd = ang*(pi/180)
        elif (trials3.thisN > 47 and trials2.thisN <= 71):
            ang = 22.5
            rtd = ang*(pi/180)
        else:
            ang = 30
